...
function GameCard({ zone, onClick, index: index2 }) {
  const coverUrl = zone.cover.replace(
    "{COVER_URL}",
    "https://cdn.jsdelivr.net/gh/gn-math/covers@main"
  );
  const ocid = index2 !== void 0 ? `game.card.${index2 + 1}` : void 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-video relative overflow-hidden bg-muted", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full border-2 border-white/80 flex items-center justify-center bg-black/40 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              "aria-label": "Play",
              role: "img",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate group-hover:text-neon-blue transition-colors duration-200", children: zone.name }),
          zone.author && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate mt-0.5", children: zone.author })
        ] })
      ]
    }
  );
  ...
  reactExports.useEffect(() => {
    ...
    const draw = () => {
      ...
      for (let i = 0; i < particles.length; i++) {
        ...
        ctx.shadowBlur = 8;
        ctx.shadowColor = "rgba(140, 60, 255, 0.6)";
        ctx.fill();
        ctx.shadowBlur = 0;
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (dist < MAX_DIST) {
            ...
            grad.addColorStop(0, `rgba(140, 60, 255, ${alpha})`);
            grad.addColorStop(0.5, `rgba(80, 120, 255, ${alpha * 0.8})`);
            grad.addColorStop(1, `rgba(140, 60, 255, ${alpha})`);
            ctx.beginPath();
            ctx.moveTo(p.x, p.y);
...
function SettingsModal({
  ...
  const [theme, setTheme] = reactExports.useState(settings.theme);
  const [panicKey, setPanicKey] = reactExports.useState(settings.panicKey);
  reactExports.useEffect(() => {
  ...
  const handleSave = () => {
    ...
    ue.success("Settings saved!", {
      description: panicKey ? `Panic key set to: ${panicKey}` : "No panic key configured"
    });
    onClose();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (o2) => !o2 && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      style: {
        boxShadow: "0 0 40px oklch(60% 0.32 300 / 0.3), 0 0 80px oklch(60% 0.32 300 / 0.1)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-xl neon-text-purple", children: "⚙ Settings" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 py-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-semibold text-muted-foreground uppercase tracking-widest", children: "Theme" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", "data-ocid": "settings.theme_toggle", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Press this key to instantly redirect to Google. Leave empty to disable." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "panic-key",
            ...
            panicKey && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-neon-blue", children: [
              "Current:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono bg-muted px-1.5 py-0.5 rounded", children: panicKey })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              style: {
                background: "linear-gradient(135deg, oklch(60% 0.32 300 / 0.8), oklch(65% 0.3 220 / 0.8))",
...
const defaultSettings = { theme: "dark", panicKey: "" };
...
function App() {
  ...
  const [recentlyPlayed, setRecentlyPlayed] = reactExports.useState(loadRecent);
  ...
  const fetchZones = reactExports.useCallback(async () => {
    setLoading(true);
    setError(false);
    try {
  ...
  const filteredZones = reactExports.useMemo(() => {
    if (!search.trim()) return zones;
    const q = search.toLowerCase();
    return zones.filter((z2) => z2.name.toLowerCase().includes(q));
  }, [zones, search]);
  const openGame = reactExports.useCallback((zone) => {
    setRecentlyPlayed((prev) => {
      const filtered = prev.filter((z2) => z2.id !== zone.id);
    ...
    if (zone.url.startsWith("http")) {
      ...
      fetch(`${url}?t=${Date.now()}`).then((r2) => r2.text()).then((html) => {
  ...
  const handleSaveSettings = reactExports.useCallback((newSettings) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: settings.theme === "dark" ? "oklch(8% 0.04 285)" : "oklch(96% 0.02 285)"
      },
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { zIndex: 1 }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-shrink-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h1",
                    {
                      ...
                      style: {
                        background: "linear-gradient(135deg, oklch(65% 0.3 220), oklch(60% 0.32 300))",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 relative", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      ...
                      style: {
                        boxShadow: search ? "0 0 8px oklch(65% 0.3 220 / 0.3)" : void 0
                      }
                    }
                  )
                ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container mx-auto px-4 py-8 space-y-10", children: [
            recentlyPlayed.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "recently_played.section", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-sm font-semibold tracking-widest uppercase neon-text-purple", children: "Recently Played" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4 text-muted-foreground" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 overflow-x-auto scrollbar-hide pb-2", children: recentlyPlayed.map((zone) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-48 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GameCard, { zone, onClick: openGame }) }, zone.id)) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "games.section", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-6", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-sm font-semibold tracking-widest uppercase neon-text-blue", children: search ? `Results for "${search}"` : "All Games" }),
              ...
              error && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Failed to load games." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Button,
                      {
                        onClick: fetchZones,
              ...
              loading && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: SKELETON_KEYS.map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(GameCardSkeleton, {}, k))
                }
              ),
              !loading && !error && filteredZones.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex flex-col items-center justify-center py-20 gap-3",
                  "data-ocid": "games.empty_state",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "w-12 h-12 text-muted-foreground" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: search ? `No games match "${search}"` : "No games found" })
                  ]
                }
              ),
              !loading && !error && filteredZones.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4", children: filteredZones.map((zone, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                GameCard,
                {
                  zone,
                  onClick: openGame,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border/30 py-6 mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
            "© ",
            currentYear,
            ". Built with ♥ using",
            " ",
